...
${y}
대표이사 ${_} (직인)`}if("contract"===i){let e=(b.paymentSchedule||[]).map(e=>`  - ${e.label} (${e.ratio}%): ₩${e.amount.toLocaleString("ko-KR")} — ${e.condition}`).join("\n");b.body=`표 준 용 역 계 약 서
...
제5조 (계약기간)
${b.contractStartDate||$} ~ ${b.contractEndDate||"프로젝트 완료 시"}
