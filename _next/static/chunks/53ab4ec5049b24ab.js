...
${g}
대표이사 ${y} (직인)`}if("contract"===n){let e=(_.paymentSchedule||[]).map(e=>`  - ${e.label} (${e.ratio}%): ₩${e.amount.toLocaleString("ko-KR")} — ${e.condition}`).join("\n");_.body=`표 준 용 역 계 약 서
...
제5조 (계약기간)
${_.contractStartDate||x} ~ ${_.contractEndDate||"프로젝트 완료 시"}
