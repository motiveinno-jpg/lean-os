...
export function FunnelChart({ stages, height = 220 }: FunnelChartProps) {
  if (stages.length === 0) {
    return <div className="funnel-chart-empty">데이터 없음</div>;
  }
  ...
  return (
    <>
      ...
      <div className="funnel-chart-desktop" style={{ height, transform: "translateZ(0)", contain: "paint" }}>
        ...
        <div className="funnel-chart-labels">
          {stages.map((s, i) => {
            ...
            return (
              <div
                key={i}
                className="funnel-chart-label-row"
              >
      ...
      <div className="funnel-chart-mobile">
        {stages.map((s, i) => {
