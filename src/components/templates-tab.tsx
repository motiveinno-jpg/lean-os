...
export function TemplatesTab({ scope, companyId, userId, templates, onInvalidate }: {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="templates-tab-header flex items-center justify-between">
      ...
      {showForm && (
        <div className="templates-form glass-card p-6">
          <h3 className="text-sm font-bold mb-4 text-[var(--text)]">
            {editingId ? "양식 수정" : "새 양식 등록"}
          </h3>

          <div className="templates-form-grid grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <div>
          ...
          {/* Sections */}
          <div className="templates-sections mb-4">
            <div className="templates-section-header flex items-center justify-between mb-2">
            ...
            <div className="space-y-3">
              {form.content_json.sections.map((sec: any, idx: number) => (
                <div key={idx} className="templates-section-item bg-[var(--bg-surface)] rounded-xl border border-[var(--border)] p-4">
                  <div className="templates-section-item-header flex items-center justify-between mb-2">
          ...
          {/* Variables */}
          <div className="templates-variables mb-4">
            <label className="block text-xs text-[var(--text-muted)] mb-2">변수 (&#123;&#123;변수명&#125;&#125; 형식으로 본문에 사용)</label>
            <div className="flex flex-wrap gap-2 mb-2">
              {form.variables.map((v: string) => (
                <span key={v} className="templates-variable-chip inline-flex items-center gap-1 px-2.5 py-1 bg-[var(--primary)]/10 text-[var(--primary)] rounded-full text-xs">
                  {`{{${v}}}`}
                  <button onClick={() => removeVariable(v)} className="text-[var(--primary)] hover:text-red-400">&times;</button>
                </span>
              ))}
            </div>
            <div className="templates-variable-input-row flex gap-2">
          ...
          <div className="templates-form-actions flex gap-2">
      ...
      {/* Templates List */}
      <div className="templates-list glass-card overflow-hidden">
        {scopedTemplates.length === 0 ? (
          <div className="templates-list-empty p-16 text-center">
            ...
            {scopedTemplates.map((tpl: any) => {
              ...
              return (
                <div key={tpl.id} className="template-row">
                  <div className="template-row-header px-5 py-4 hover:bg-[var(--bg-surface)] transition">
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="template-row-badges flex items-center gap-2">
                        ...
                        {vars.length > 0 && (
                          <div className="template-row-vars flex flex-wrap gap-1 mt-1.5">
                      ...
                      <div className="template-row-actions flex items-center gap-2">
                  ...
                  {isPreview && previewTemplate && (
                    <div className="template-preview-panel px-5 pb-4">
