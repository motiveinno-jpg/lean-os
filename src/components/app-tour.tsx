...
const TOUR_STEPS: TourStep[] = [
  ...
  { href: "/dashboard", title: "대시보드", desc: "잔고·매출·오늘 할 일을 한 화면에서 봅니다. 위젯은 원하는 대로 배치합니다." },
  { href: "/copilot", title: "AI 참모", desc: "자금·매출·인사 현황을 AI에게 바로 물어봅니다. 결재 상신 같은 일도 대신 처리합니다." },
  {
    ...
    howTo: {
      ...
      steps: [
        ...
        "회사 인증서를 고르고 비밀번호를 입력합니다.",
        "홈택스 연결하기를 누르면 세금계산서가 자동으로 모입니다.",
      ],
  ...
  },
  {
    ...
    howTo: {
      ...
      steps: [
        "설정 > 연동·인증에서 은행 또는 카드를 선택합니다.",
        "거래 은행을 고르고 인증서 또는 뱅킹 아이디 방식을 선택합니다.",
        "인증서를 고르고 비밀번호를 입력합니다.",
        "연결하기를 누르면 거래내역이 자동으로 모입니다.",
      ],
      link: { label: "설정 > 연동·인증 바로 가기", href: "/settings/integration?tab=bank" },
    },
  },
  { href: "/schedule", title: "일정 / 할 일", desc: "회사 일정과 할 일을 한곳에서 관리하고 팀원과 공유합니다." },
  { href: "/projecthub", title: "프로젝트", desc: "수주부터 입금과 마진까지 프로젝트 손익을 추적합니다." },
  {
    href: "/approvals", title: "결재 허브",
    desc: "지출결의·휴가 같은 사내 결재를 전자로 처리합니다. 양식은 회사에 맞게 직접 만듭니다.",
    howTo: {
      label: "회사 결재 양식 만드는 방법",
      steps: [
        "결재 허브의 양식 관리 탭으로 이동합니다.",
        "새 양식 추가에서 이름·입력 필드·내용 템플릿을 정합니다.",
        "결재선을 단계별로 지정하면 새 요청에서 바로 쓸 수 있습니다.",
      ],
  ...
  { href: "/board", title: "게시판 · 메신저", desc: "공지와 소통을 게시판·메신저에서 합니다. 직원을 초대하면 바로 함께 씁니다." },
  {
    ...
    howTo: {
      label: "직원 초대·등록 방법",
      steps: [
        "구성원에서 직원 초대를 누르고 이름·이메일을 입력합니다.",
        "초대를 수락한 직원은 직접 로그인해 출퇴근·급여명세서를 봅니다.",
        "직원 상세의 탭 권한에서 보여줄 메뉴를 고릅니다.",
      ],
  ...
  },
  {
    ...
    howTo: {
      label: "계좌·카드 연결 방법",
      steps: [
        "설정 > 연동·인증에서 은행·카드를 연결합니다.",
        "전 계좌 잔액과 거래가 하루 2회 자동 동기화됩니다.",
  ...
  },
  {
    ...
    howTo: {
      ...
      steps: [
        "연동·인증에서 통장·카드·홈택스를 연결합니다.",
        "회사 정보에 사업자등록증 같은 회사 문서를 올립니다.",
        "직인을 등록하면 세금계산서·계약서에 자동 날인됩니다.",
      ],
