...
function StatCard({ tone, icon, label, value, trend }: {
  ...
  return (
    <div className="card-stat-tile glass-card">
...
export function CardsOverview({ companyId, onSelectCard }: Props) {
  ...
  return (
    <div className="cards-overview">
      ...
      <div className="cards-control-bar glass-card">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="cards-date-range-nav">
        ...
        {/* 검색 + 정렬 */}
        <div className="cards-search-sort">
          <input
            value={search}
      ...
      {isLoading ? (
        ...
        <div className="cards-empty glass-card">
          ...
          {flatCards.map((c) => {
            ...
            return (
              <button
                ...
                className="card-tile group glass-card"
              >
