...
export function ContractViewer({ id, backHref }: { id: string; backHref?: string }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* 감사 메타 — print 시 숨김 */}
      <div className="contract-viewer-meta">
      ...
      <div className="contract-viewer-body print-area">
        ...
        {!/class="sig-box"/.test(html) && (
          <div className="contract-viewer-signature-footer">
      ...
      {showOurSignModal && (
        <div
          className="our-sign-modal fixed inset-0"
          onClick={() => !submittingOurSig && setShowOurSignModal(false)}
        >
          <div
            className="our-sign-modal-panel"
