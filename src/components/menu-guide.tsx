...
export function MenuGuide() {
  ...
  return (
    <div ref={wrapRef} className="relative pointer-events-auto">
      ...
      {open && (
        <div className="absolute top-full right-0 mt-2 w-[min(92vw,360px)] max-h-[70vh] overflow-y-auto rounded-2xl border border-[var(--border)] bg-[var(--bg-card)] z-50 animate-[slide-in_0.15s_ease]"
          style={{ boxShadow: "var(--shadow-lg, 0 12px 32px rgba(0,0,0,0.18))" }}>
          {/* 헤더 */}
