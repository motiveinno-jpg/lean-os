      ...
      <footer className="lp4-footer">
        <div className="lp4-container">
          ...
          <div className="lp4-footer-bottom">
            ...
            <div className="lp4-flinks"><Link href="/terms">이용약관</Link><Link href="/privacy">개인정보처리방침</Link><Link href="/blog">블로그</Link><Link href="/security">보안</Link><Link href="/refund">환불규정</Link><a href={`mailto:${FOOTER.email}`}>{FOOTER.email}</a></div>
          </div>
        </div>
      </footer>
    </div>
