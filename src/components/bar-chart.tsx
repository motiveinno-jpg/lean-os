...
export function BarChart({ data, height = 220, onBarClick, trendLine, trendColor = 'var(--warning)' }: BarChartProps) {
  ...
  return (
    ...
    <div className="bar-chart" style={{ height }}>
      ...
      <div className="bar-chart-y-axis mono-number">
      ...
      <div className="bar-chart-area">
        <div className="bar-chart-plot">
          ...
          {data.map((group, gi) => (
            <div
              key={gi}
              className={`bar-chart-group ${hover === gi ? 'bg-[var(--bg-surface)]' : ''}`}
              ...
              {group.values.map((v, vi) => {
                ...
                return (
                  <div key={vi} className="flex-1 relative h-full group">
                    ...
                    {/* Tooltip */}
                    {hover === gi && (
                      <div className="bar-chart-tooltip mono-number">
          ...
          {trendPoints && (
            <div
              className="bar-chart-trend-overlay"
            >
