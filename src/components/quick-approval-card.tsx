...
export function QuickApprovalCard({ companyId, userId }: { companyId: string; userId: string }) {
  ...
  return (
    <div className="quick-approval-card glass-card">
      ...
      <div className="quick-approval-grid">
        <Link href="/approvals?new=expense"
          ...
          <span className="w-9 h-9 shrink-0 rounded-lg flex items-center justify-center bg-emerald-500/10 text-emerald-600 text-base leading-none"><Ico e="💳" tone="mono" /></span>
        ...
        <Link href="/approvals?new=payment"
          ...
          <span className="w-9 h-9 shrink-0 rounded-lg flex items-center justify-center bg-blue-500/10 text-blue-600 text-base leading-none"><Ico e="📝" tone="mono" /></span>
          <div className="flex-1 min-w-0">
        ...
        <Link href="/leave?new=1"
          ...
          <span className="w-9 h-9 shrink-0 rounded-lg flex items-center justify-center bg-orange-500/10 text-orange-500 text-base leading-none"><Ico e="🏖" tone="mono" /></span>
          <div className="flex-1 min-w-0">
        ...
        <Link href="/approvals?new=general"
          ...
          <span className="w-9 h-9 shrink-0 rounded-lg flex items-center justify-center bg-violet-500/10 text-violet-600 text-base leading-none"><Ico e="📋" tone="mono" /></span>
          <div className="flex-1 min-w-0">
