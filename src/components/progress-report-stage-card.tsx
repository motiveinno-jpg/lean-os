...
export function ProgressReportStageCard({
  ...
  return (
    <div className="progress-report-stage-card">
      ...
      {mode === "edit" ? (
        <div className="progress-report-edit-form">
          <div>
      ...
      {!readonly && (mode === "edit" || (mode === "preview" && (!approval || approval?.status === "draft"))) && (
        <div className="progress-report-save-send-bar">
...
function ProgressDetailModal({
  ...
  return (
    <div
      className="progress-detail-modal-overlay fixed inset-0"
      onClick={onClose}
      role="dialog"
      aria-modal="true"
    >
      <div
        ...
        className="progress-detail-modal"
      >
        {/* 헤더 */}
        ...
        {/* 본문 */}
        <div className="progress-detail-modal-body">
          {/* 진행률 바 (크게) */}
          <div>
