...
export function TopCardExpensesThisMonth({ companyId }: Props) {
  ...
  return (
    <div className="top-card-expenses glass-card">
      <div className="top-card-expenses-header">
      ...
      {top.length === 0 ? (
        ...
        <div className="top-card-expenses-list">
          {top.map((t: any, i: number) => {
            ...
            return (
              <div key={t.id} className="top-card-expense-row">
...
export function CardAutoTransferHistory({ companyId }: Props) {
  ...
  return (
    <div className="card-auto-transfer glass-card">
      <div className="card-auto-transfer-header">
        <div className="flex items-center gap-2.5">
      ...
      {items.length === 0 ? (
        ...
        <div className="card-auto-transfer-list">
          {items.map((t: any) => {
            ...
            const dateDisplay = isNaN(d.getTime()) ? dStr : `${d.getMonth() + 1}/${d.getDate()}`;
            return (
              <div key={t.id} className="card-auto-transfer-row">
                <div className="text-[10px] text-[var(--text-dim)] w-10 mono-number">{dateDisplay}</div>
                <div className="flex-1 min-w-0">
...
export function CardMonthlyUsage({ companyId }: Props) {
  ...
  return (
    <div className="card-monthly-usage glass-card">
      <div className="card-monthly-usage-header">
        <div className="flex items-center gap-2.5">
  ...
  return (
    <div className="card-per-card-table">
      <button
        type="button"
        onClick={toggle}
        className="card-per-card-toggle"
      >
