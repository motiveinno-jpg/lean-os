...
const HUBS: Hub[] = [
  ...
  //   'tax' 허브(세금계산서·전자계산서·현금영수증)는 없앴다.
  ...
  //   'ledger' 허브(자동 분류 · 통장 처리)도 뺐다 (2026-08-18 조회 표준 확산 Wave 1 — 대표 위임 결정).
  //   자동 분류(/transactions)가 하던 일은 전부 수집·전표 › 통장 탭이 맡는다 — 같은 일을 두 화면에 두면
  //   어디서 확정했는지 헷갈린다. 라우트는 살려 두고 화면 위에 통합 안내만 붙였다.
];
