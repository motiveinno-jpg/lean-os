    ...
    <div className="flex gap-4">
      ...
      <div className="flex-1">
        ...
        <div
          ...
          className="relative w-full select-none overflow-hidden rounded border border-gray-300"
        ...
        >
          ...
          {pageFields.map(({ f, i }) => (
            <div
              ...
              className={`absolute cursor-move border-2 text-[10px] ${i === selected ? "border-indigo-600 bg-indigo-500/20" : "border-amber-500 bg-amber-400/15"}`}
