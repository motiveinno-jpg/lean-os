...
export function DashboardSiyanHero({
  ...
  return (
    <div className="dashboard-siyan-hero-grid">
      {/* 총 자금 */}
      <div className="kpi-balance-card glass-card">
      ...
      {/* 이번달 매출 */}
      <div className="kpi-revenue-card glass-card">
        <div className="flex items-center justify-between">
      ...
      {/* 월 운영비 */}
      <div className="kpi-expense-card glass-card">
        <div className="flex items-center justify-between">
      ...
      <div className="kpi-ar-card glass-card">
        <div className="flex items-center justify-between">
...
export function DashboardCostBars({ costBreakdown }: { costBreakdown?: Breakdown }) {
  ...
  return (
    <div className="cost-bars-card glass-card">
      <div className="cost-bars-header">
      ...
      <div className="cost-bars-list">
        {cats.map((c, i) => {
          ...
          return (
            <div key={c.label} className="cost-bars-row">
