...
export const CONTACT = {
  h1: "도입 상담 신청",
  lead: "회사에서 지금 어떻게 일하고 계신지 알려 주세요. 필요한 메뉴와 요금을 정리해 연락드립니다.",
  steps: [
    ["신청", "아래 칸을 채워 보내 주세요. 모르는 칸은 비워 두셔도 됩니다."],
    ["연락", "영업일 기준 1일 이내에 남기신 이메일이나 연락처로 연락드립니다."],
    ["안내", "업무 순서를 들은 뒤 쓰실 메뉴, 옮길 자료, 요금을 함께 정리합니다."],
  ] as [string, string][],
  sizes: ["1~5명", "6~20명", "21~50명", "51명 이상"],
  interests: ["회계 · 세무", "통장 · 카드 수집", "재고 · 이커머스", "인사 · 급여", "프로젝트 · 협업", "전자계약 · 결재"],
  consent: "수집 항목: 회사명, 담당자명, 이메일, 연락처 · 목적: 도입 상담 회신 · 보유 기간: 상담 목적을 달성하면 지체 없이 파기합니다.",
};
