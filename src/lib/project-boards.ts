// 프로젝트 표(보드) — 새 프로젝트 구조의 뼈대 (2026-08-03 기획 v2,).
//
...
//
// 단계는 '섹션'이 아니라 '라벨'이다 ("요청·작업중·검수·완료로 섹션이
...
/** 이 템플릿이 쓸 수 있는 입력 화면들 — **그 일의 첫 화면**이 맨 앞이다 (
...
export const BOARD_TEMPLATES: BoardTemplate[] = [
  ...
  {
    //   마케팅 계정 관리 — 값은 사람이 아니라 매체 API 가 채운다.
...
// ── 마케팅(광고) 표 — 값은 사람이 아니라 매체 API 가 채운다 ──
//   ⚠️ 어느 칸에 무엇을 채울지는 **이름이 아니라 settings.ad 로** 정한다.
//      대표 칸 이름을 바꿔도(예: '비용' → '광고비') 채우는 자리가 어긋나지 않게.
