...
2. 유료 기능을 이용하려면 서비스 내 "요금제" 화면에서 요금제를 선택하고 결제수단(신용·체크카드)을 등록해야 합니다.
3. 무료체험은 회원가입 시점이 아니라 <b>결제수단 등록이 완료된 시점</b>부터 시작됩니다.
4. 결제수단 등록 시 카드 유효성 확인을 위한 0원 승인이 이루어질 수 있으며, 이는 실제 청구가 아닙니다.`,
  },
  {
    id: "3",
    title: "제3조 (무료체험)",
    content: `1. 기본 무료체험 기간은 결제수단 등록일로부터 <b>14일</b>입니다.
2. 회사가 발급한 영업코드를 결제수단 등록 시 함께 입력한 경우, 30일이 추가되어 <b>총 44일</b>의 무료체험이 적용됩니다.
3. 회원에게 실제 적용된 체험 종료일은 서비스 내 "요금제" 화면에 명시되며, 그 날짜가 본 규정의 기준이 됩니다.
4. 체험 기간 중에는 이용 요금이 청구되지 않습니다.
5. 체험 종료일 이전에 해지하면 <b>첫 결제가 발생하지 않습니다.</b> 이 경우 환불 대상 자체가 존재하지 않으며, 유료 기능은 해지 즉시 또는 체험 종료 시점에 중단됩니다.
6. 체험 종료 시점까지 유효한 결제수단이 등록되어 있지 않으면 구독은 자동으로 취소되며 요금은 청구되지 않습니다.`,
  },
  {
    id: "4",
    title: "제4조 (요금제와 결제 주기)",
    content: `1. 유료 요금제는 프로, 울트라, 엔터프라이즈로 구분되며, 결제 주기는 <b>월간</b> 또는 <b>연간</b> 중 선택할 수 있습니다.
2. 월간 결제는 매월 같은 날 자동 갱신되어 1개월분이 청구됩니다.
3. 연간 결제는 <b>1년치 요금 전액이 최초 1회 일시 청구</b>되며, 월간 정가 대비 10% 할인이 적용됩니다. 이후 매년 같은 날 자동 갱신됩니다.
4. 각 요금제에는 기본 좌석이 포함되며, 기본 좌석을 초과하는 인원에 대해서는 좌석당 추가 요금이 동일한 결제 주기로 합산 청구됩니다.
5. 모든 표시 금액은 부가가치세(VAT) 10%가 별도이며, 결제 시 합산 청구됩니다.
6. 엔터프라이즈 요금제는 별도 계약에 따르며, 계약서에 정한 조건이 본 규정에 우선합니다.`,
  },
  {
    id: "5",
    title: "제5조 (해지)",
...
4. 해지 신청 이후 이용기간 만료 전에는 해지를 취소하여 구독을 계속 유지할 수 있습니다.`,
  },
  {
    ...
    title: "제6조 (환불)",
    content: `<b>[무료체험 중]</b>
청구가 발생하지 않았으므로 환불 대상이 없습니다. 체험 종료일 이전에 해지하면 요금이 청구되지 않습니다.

<b>[월간 결제]</b>
이미 결제된 해당 월의 요금은 환불되지 않습니다. 대신 제5조에 따라 결제한 1개월이 끝날 때까지 서비스를 계속 이용할 수 있습니다.

<b>[연간 결제]</b>
이미 결제된 1년치 요금은 <b>중도 해지 시에도 환불되지 않습니다.</b> 대신 결제한 1년의 <b>잔여기간 동안 추가 비용 없이 서비스를 그대로 계속 이용</b>할 수 있으며, 기간 만료 시 자동 갱신 없이 종료됩니다. 연간 결제를 선택하기 전 이 조건을 반드시 확인하시기 바랍니다.
...
2. 다만 다음의 경우에는 청약철회가 제한될 수 있습니다.
  가. 결제 이후 서비스의 유료 기능을 실제로 이용한 경우
  나. 회원의 책임 있는 사유로 서비스가 훼손된 경우
3. 서비스는 사업자를 대상으로 하는 B2B 서비스로서, 사업자 간 거래에는 위 법률의 청약철회 규정이 적용되지 않을 수 있습니다. 다만 회원이 소비자에 해당하는 경우에는 관계 법령이 본 규정에 우선합니다.
4. 무료체험 기간 중 해지는 청구 자체가 발생하지 않으므로 청약철회 절차 없이 처리됩니다.`,
  },
  {
    id: "8",
...
const SUMMARY = [
  { plan: "무료체험", price: "0원 (카드 등록 필요)", refund: "카드 등록일부터 14일 · 영업코드 입력 시 44일 · 종료 전 해지하면 청구 없음" },
  { plan: "프로 (월간)", price: "79,500원 / 월 (VAT 별도)", refund: "언제든 해지 · 결제한 1개월 만료까지 이용 · 당월분 환불 없음" },
  { plan: "프로 (연간)", price: "858,600원 / 년 (VAT 별도, 10% 할인)", refund: "언제든 해지 · 환불 없음 · 결제한 1년 잔여기간 그대로 이용" },
  { plan: "울트라 (월간)", price: "110,000원 / 월 (VAT 별도)", refund: "언제든 해지 · 결제한 1개월 만료까지 이용 · 당월분 환불 없음" },
  { plan: "울트라 (연간)", price: "1,188,000원 / 년 (VAT 별도, 10% 할인)", refund: "언제든 해지 · 환불 없음 · 결제한 1년 잔여기간 그대로 이용" },
