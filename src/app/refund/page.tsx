...
const SECTIONS = [
  ...
  },
  {
    id: "2",
    title: "제2조 (무료체험 및 결제)",
    content: `1. 신규 가입 시 결제수단(카드)을 등록하고 14일간 유료 기능을 무료로 체험할 수 있습니다. 체험 기간 중에는 실제 청구가 발생하지 않습니다.
2. 체험 기간이 종료되면, 가입 시 선택한 요금제로 등록된 결제수단에 자동으로 첫 결제가 청구됩니다.
3. 체험 기간(가입 후 14일) 이내에 해지하면 첫 결제가 발생하지 않으며, 유료 기능 이용은 체험 종료 시점에 중단됩니다.
4. 결제 금액은 선택한 요금제 기준이며, 부가가치세(VAT) 10%가 별도 청구됩니다.`,
  },
  {
    id: "3",
...
[1. 무료체험 (가입 후 14일)]
- 체험 기간 중에는 실제 청구가 발생하지 않습니다.
- 체험 기간 이내에 해지하면 첫 결제가 발생하지 않습니다.
...
const SUMMARY = [
  { plan: "무료체험 (14일)", price: "0원 (카드 등록)", refund: "체험 중 청구 없음 · 14일 내 해지 시 첫 결제 없음" },
  { plan: "프로", price: "79,500원 / 월 (VAT 별도)", refund: "언제든 해지 가능, 당월 결제분 환불 없음" },
  { plan: "울트라", price: "110,000원 / 월 (VAT 별도)", refund: "언제든 해지 가능, 당월 결제분 환불 없음" },
