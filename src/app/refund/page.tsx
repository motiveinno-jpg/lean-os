...
3. 연간 결제는 <b>1년치 요금 전액이 최초 1회 일시 청구</b>되며, 월간 정가 대비 할인이 적용됩니다. 할인율과 최종 금액은 결제 화면에 표시된 금액을 따릅니다. 이후 매년 같은 날 자동 갱신됩니다.
...
const SUMMARY = [
  ...
  { plan: "오너뷰 (월간)", price: "25,000원 / 월 (VAT 별도) · 기본 5명 포함, 추가 1명당 5,000원", refund: "언제든 해지 · 결제한 1개월 만료까지 이용 · 당월분 환불 없음" },
  { plan: "오너뷰 (연간)", price: "결제 화면에 표시된 1년치 금액 (VAT 별도, 월간 대비 할인 적용)", refund: "언제든 해지 · 환불 없음 · 결제한 1년 잔여기간 그대로 이용" },
  { plan: "충전 (발행·AI 토큰)", price: "발행 300원/건 · AI 토큰 100만개 10,000원 (VAT 별도)", refund: "결제 즉시 잔액 적립 · 사용 개시된 충전분은 환불 불가" },
