...
export function DataResetTab({ companyId }: { companyId: string }) {
  ...
  return (
    <div className="space-y-6">
      {/* 경고 배너 */}
      <div className="data-reset-warning-banner">
      ...
      {/* 전체 데이터 초기화 */}
      <div className="data-reset-panel">
        ...
        {/* 삭제 대상 목록 */}
        <div className="data-reset-delete-list">
          ...
          <div className="data-reset-keep-list">
        ...
        {step === "confirm" && (
          <div className="data-reset-confirm-form">
        ...
        {step === "processing" && (
          <div className="data-reset-progress">
        ...
        {step === "done" && (
          <div className="data-reset-done-summary">
