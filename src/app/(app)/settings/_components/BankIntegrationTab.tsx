...
function CodefErrorCard({ item, onRetry, retrying }: { item: any; onRetry: () => void; retrying: boolean }) {
  ...
  return (
    <li className="bank-integration-error-card">
        ...
        {isConnected ? (
          <div className="space-y-3">
            ...
            {syncResult && (
              ...
              <div className={`bank-integration-sync-result ${syncResult.ok ? "bg-green-500/10 text-green-600 border border-green-500/20" : "bg-red-500/10 text-red-500 border border-red-500/20"}`}>
