...
const FEATURES: GuideFeature[] = [
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      '발행 알림 메일 — 발행이 완료되면 지정한 주소로 자동 통보 (설정 > 은행연동 > 홈택스)',
      '요약 탭 — 기간별 증빙 현황을 한눈에',
    ],
    tips: '설정 > 은행연동에서 공동인증서를 등록하면 자동 수집이 시작됩니다.',
  },
  {
    id: 'collect',
    icon: '📥',
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      '손익 확인 — 확정 전표 기준으로 계정과목별 집계',
      '원장 드릴다운 — 손익 계정을 누르면 전표번호·거래처·적요와 월계·누계까지',
  ...
  },
  {
    ...
    category: '운영',
    description:
      '회사정보(직인·문서·세무 파트너·결재 총괄 알림), 구성원·초대, 자금·통장, 계정과목·분류, 회계마감, 은행연동, 근태 기준, 회사 양식까지 서비스 전반을 설정합니다. 요금제 메뉴에서 구독 플랜과 결제를 관리합니다.',
    route: '/settings',
    keyFeatures: [
      '회사정보 — 사업자 정보·직인·회사 문서·세무 파트너 연결',
      '결재 상신 알림 — 총책임자 메일 주소를 지정하면 모든 상신을 메일로 통보',
      '은행연동 — 공동인증서 등록으로 금융·홈택스 자동 수집, 발행 알림 메일 주소 설정',
      '자금·통장 — 가용 현금 집계와 미연동 계좌, 지급 통장 규칙',
      '요금제 — 구독 플랜 변경, 월간/연간 결제 관리',
    ],
    tips: '공동인증서 등록이 자동화의 시작점입니다. 설정 > 은행연동에서 등록하세요.',
  },
];
