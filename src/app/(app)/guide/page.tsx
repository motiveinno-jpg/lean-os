...
const FEATURES: GuideFeature[] = [
  ...
  },
  {
    ...
    keyFeatures: [
      '서명 요청 · 이메일이나 링크로 요청',
      '거래처 바로 수정 · 새 계약 요청 표에서 대표자·이메일·사업자번호까지 편집',
      '상태 추적 · 대기·완료 실시간 확인',
  ...
  },
  {
    ...
    category: '운영',
    description:
      '체결한 계약의 기간과 금액을 한 표로 관리합니다. 만료가 다가오는 계약과 기간을 아직 안 적은 계약을 따로 모아 보여주고, 빈 기간은 대장에서 바로 채울 수 있습니다.',
    route: '/contracts',
    keyFeatures: [
      '상태별 보기 · 진행 중 / 만료 임박(60일) / 종료 / 기간 미입력',
      '만료 임박 D-n · 종료일까지 남은 날짜 표시',
      '기간 채우기 · 기간 미입력 계약은 표에서 바로 입력',
      '프로젝트 연결 · 계약이 속한 프로젝트로 이동',
    ],
    tips: '계약서 편집기에서 계약 기간을 적으면 자동으로 대장에 반영됩니다.',
  },
  {
    id: 'hr-templates',
    icon: '📄',
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      '초대·합류 · 이메일 초대와 가입 승인',
      '급여 · 급여명세서 생성·발송 (국세청 간이세액표·4대보험 자동 계산)',
      '휴가 관리 · 연차 자동 부여와 잔여 추적',
      '퇴사 처리 · 상실사유(대분류→구체적 사유)·퇴직금 정산·체크리스트',
      '증명서 발급 · 재직증명서 등 발급',
      '권한 부여 · 구성원별 메뉴 권한 지정',
    ],
  ...
  },
  {
    ...
    keyFeatures: [
      ...
      '기록 상세 · 날짜별 출근·지각·결근·휴가 현황 확인과 관리자 정정',
