...
export default function ErrorLogsPage() {
  ...
  return (
    <div className="bg-[var(--bg)] text-[var(--text)] -mx-6 -my-6 px-6 py-6 min-h-screen rounded-none">
      {/* 툴바 — 필터(좌) + 액션(우) */}
      <div className="error-log-toolbar page-sticky-header">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="error-log-filter-bar">
        ...
        <div className="error-log-list">
          {filtered.map((r) => {
            ...
            return (
              ...
              >
                <div className="error-log-card-header">
                  <button
                ...
                {expanded && (
                  <div className="error-log-detail">
                    ...
                    {/* 발생 맥락 */}
                    <div className="error-log-context-grid">
