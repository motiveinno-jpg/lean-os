...
export default function LoansPage() {
  ...
  return (
    <div className="loans-print-area">
      ...
      {/* List Tab */}
      {tab === "list" && (<>
        <div className="loans-list-panel glass-card">
          {loans.length === 0 ? (
            <EmptyState
              icon="🏦"
        ...
        {loans.length > 0 && (
          <div className="mt-6 space-y-6">
            ...
            <div className="loan-portfolio-summary glass-card">
              ...
              {/* Per-loan bars */}
              <div className="loan-repayment-bars">
      ...
      {/* Payments Tab */}
      {tab === "payments" && (
        <div className="loan-payments-panel">
          {/* Add payment button */}
          ...
          {/* Payment form */}
          {showPayForm && (
            <div className="loan-payment-form glass-card">
          ...
          {/* Payments table */}
          <div className="loan-payments-table glass-card">
      ...
      {tab === "match" && (
        <div className="loan-match-panel">
          ...
          <div className="loan-match-list glass-card">
              ...
              <div className="divide-y divide-[var(--border)]/50">
                {matchCandidates
                  ...
                  .map((candidate) => {
                    ...
                    return (
                      <div key={candidate.transaction.id} className="loan-match-candidate">
      ...
      {/* Register Tab */}
      {tab === "register" && (
        <div className="loan-register-form glass-card">
