      ...
      <div className="flex-1 flex flex-col min-w-0 bg-[var(--bg-card)] rounded-xl border border-[var(--border)] overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
          {messages.length === 0 && (
            <div className="flex flex-col items-center justify-center h-full text-center opacity-40">
              ...
              <div className="text-sm font-medium text-[var(--text-secondary)]">OwnerView AI 어시스턴트</div>
        ...
        <form onSubmit={handleSubmit} className="px-4 py-3 border-t border-[var(--border)] flex gap-2">
          <input
            ...
            className="flex-1 bg-[var(--bg-surface)] border border-[var(--border)] rounded-lg px-4 py-2.5 text-xs text-[var(--text)] placeholder:text-[var(--text-dim)] focus:outline-none focus:border-[var(--primary)] transition"
            disabled={loading || !companyId}
          />
          <button
            type="submit"
