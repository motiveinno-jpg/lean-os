...
export function VoucherEditModal({ entryId, companyId, onClose, onSaved, newFor }: {
  ...
  return createPortal(
    <div className="voucher-edit-overlay fixed inset-0">
      ...
      >
        <div onMouseDown={startDrag} className="voucher-edit-header">
          <div>
  ...
  return (
    <div className="partner-detail-overlay fixed inset-0" onClick={onClose}>
      <div className="partner-detail-modal" onClick={(e) => e.stopPropagation()}>
        ...
        {/* 세금계산서 목록 */}
        <div className="partner-detail-invoice-list">
          {isLoading ? (
            ...
            shownInv.map((inv) => {
              ...
              return (
                <div key={inv.id} className="partner-detail-invoice-row">
