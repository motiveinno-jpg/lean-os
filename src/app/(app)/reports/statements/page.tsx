...
const DOCS = [
  ...
  { href: "/reports/ledger", title: "계정별 원장 · 합계잔액시산표", desc: "계정과목 하나를 날짜순 차변·대변·잔액으로, 전 계정의 합계·잔액을 시산표로. 확정 전표 기준." },
  { href: "/reports/cashflow", title: "현금흐름표 (직접법)", desc: "통장 거래를 영업·투자·재무 활동으로 나눠 기초·기말 현금까지. 통장 거래 기준." },
  { href: "/reports/costs", title: "비용 분석 (고정비·변동비)", desc: "비용을 항목·성격(고정/변동)별로 상세 분해." },
  { href: "/reports/by-person", title: "인원별 급여", desc: "직원별 급여를 사람·월 기준으로 봅니다." },
