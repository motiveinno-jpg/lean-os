...
export function FlowSchedule({ companyId, userId }: { companyId: string; userId?: string }) {
  ...
  return (
    <div className="flow-schedule-card glass-card">
      <div className="flow-schedule-header">
        ...
        <div className="flow-schedule-totals">
          ...
          {byMonth.map(([ym, list]) => {
            ...
            return (
              <div key={ym} className="flow-schedule-month-group">
                <div className="flow-schedule-month-header">
                  <span>{ym}</span>
                  <span className="mono-number">순 {mi - mo >= 0 ? "+" : ""}₩{won(mi - mo)}</span>
                </div>
                <div className="space-y-1">
                  {list.map((it, i) => (
                    <div key={i} className="flow-schedule-item">
