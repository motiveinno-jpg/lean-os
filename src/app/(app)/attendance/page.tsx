...
export default function AttendancePage() {
  ...
  const ATT_EMP_COLS = "id,name,department,position,user_id,email,hire_date,resignation_date,status,employee_number";   // 퇴사일 — 퇴사 후 결근 파생 차단에 쓴다   // 사번 — 이름 옆 태그·정렬 (2026-08-27)
          ...
          <QueryBody>
            <div className="att-scroll">
              ...
              {/* 월간 요약 — 부서→직원 표(지각·결근·재택·반차·연차·연장·야간·휴일·총 근무·수당). 예전 연장근무 갈래 자리
                  (연장근무 신청·승인은 결재 허브로, 여기는 인사팀이 보는 월간 지표) */}
              {/* 근태 현황 (월간 요약 → 근태 현황, 조회기간·사람/부서 다중 지정) */}
