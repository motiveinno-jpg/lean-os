...
export function PerformanceTab({ dealId, companyId, deal, users = [], onGoTab }: { dealId: string; companyId: string; deal: any; users?: any[]; onGoTab?: (t: string) => void }) {
  ...
  return (
    <div className="performance-tab space-y-5">
      ...
      {/* 성과 하위 탭 */}
      <div className="performance-subtab-bar seg-bar">
      ...
      <section className="kpi-management-section space-y-3">
        ...
        {(kpis as Kpi[]).length > 0 && (
          <div className="kpi-table-card glass-card overflow-x-auto">
      ...
      <section className="kpi-entries-section space-y-3">
        ...
        {manualKpis.length === 0 ? (
          ...
          <>
            ...
            <div className="kpi-entry-table-card glass-card overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="text-xs text-[var(--text-dim)]">
      ...
      <section className="checkin-section space-y-3">
        ...
        <div id="checkin-form" className="checkin-form-card glass-card p-4 space-y-3 scroll-mt-24">
          ...
          {(kpis as Kpi[]).filter((k) => k.source === "manual").length > 0 && (
            <div className="checkin-kpi-quick-input">
