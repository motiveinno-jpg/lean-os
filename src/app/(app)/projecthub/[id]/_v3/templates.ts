...
export const TEMPLATES: Tpl[] = [
  ...
  },
  {
    ...
    //   실제 사업명 쓰지 말 것 — 모티브가 하는 사업이 그대로 노출됐던 사고
    example: "예시 · ○○ 지원사업 공고",
  },
  {
