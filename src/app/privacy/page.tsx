...
2. 서비스 제공을 위한 필수 제3자 제공
  ...
  다. Stripe, Inc. — 해외 결제 처리
     - 제공 항목: 결제 관련 정보
     - 보유 기간: 결제 완료 후 5년
  라. (주)코드에프(CODEF) — 금융 데이터 수집 및 전자금융거래
     - 제공 항목: 사업자등록번호, 공동인증서 정보, 은행/카드 거래내역, 홈택스 세금계산서 정보
     - 보유 기간: 서비스 이용 기간 (해지 시 즉시 연결 해제)
...
function DelegationSection() {
  return (
    <div className="delegation-section text-slate-300 text-sm leading-7 space-y-4">
      <p>회사는 서비스 제공을 위하여 다음과 같이 개인정보 처리 업무를 외부에 위탁하고 있습니다.</p>
      <table className="delegation-table w-full border-collapse border border-white/10 text-left">
        <thead>
  ...
  return (
    <div className="legal-page min-h-screen bg-[#0A0E1A] text-white">
      ...
      <main className="legal-content max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="legal-intro-box p-5 rounded-xl bg-blue-500/5 border border-blue-500/10 mb-10 text-sm text-slate-300 leading-7">
        ...
        {/* Company info */}
        <div className="company-info-card mt-16 p-6 rounded-xl bg-white/[0.03] border border-white/5 text-sm text-slate-400 space-y-1">
