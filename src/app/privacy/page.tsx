...
5. 소셜 로그인(카카오·구글·네이버) 이용 시: 이메일 주소, 이름(또는 별명)
   ※ 소셜 로그인으로 제공받는 정보는 회원 식별 및 계정 연결·로그인 목적으로만 사용하며, 각 사업자의 동의 화면에서 이용자가 동의한 항목만 제공받습니다. 네이버 아이디로 로그인의 경우 이메일 주소와 회원이름만 제공받습니다.
...
- 소셜 로그인 이용 시 해당 사업자(카카오·구글·네이버)로부터 이용자 동의를 거쳐 제공받음
- 제휴 서비스로부터 제공받는 정보`,
  },
  {
    id: "2",
  ...
  return (
    <div className="legal-page">
      ...
      <main className="legal-content">
        ...
        {/* Company info */}
        <div className="company-info-card mt-16">
