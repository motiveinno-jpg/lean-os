...
export default function InvitePage() {
  return (
    <Suspense fallback={
      <div className="invite-loading-screen">
...
function InviteContent() {
  ...
  if (validating) {
    return (
      <div className="invite-validating-screen">
  ...
  if (invalid) {
    return (
      <div className="invite-invalid-screen">
  ...
  return (
    <div className="invite-accept-screen">
      <div className="w-full max-w-md">
        ...
        {/* Card */}
        <div
          className="invite-accept-card glass-card"
        >
          {/* Invite Badge */}
          ...
          {error && (
            <div role="alert" className="invite-error-banner">
              {error}
            </div>
          )}
