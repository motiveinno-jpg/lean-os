...
<div class="contract-page">
  ...
  <div class="article">
    ...
    <div class="article-body">
      <p>① 을이 납품기한을 초과하여 이행하는 경우 지체일수 1일당 계약금액의 ${p(_)}%에 해당하는 금액을 지체상금으로 갑에게 납부하여야 한다.</p>
...
</html>`}function p(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function m(e){let t=await fetch(e),a=await t.blob();return new Promise((e,t)=>{let n=new FileReader;n.onloadend=()=>e(n.result),n.onerror=t,n.readAsDataURL(a)})}function g(e){let t=Math.abs(e);return`${e<0?"-":""}${t.toLocaleString("ko-KR")}`}function f(e,t){let a=e.getNumberOfPages(),n=e.internal.pageSize.getWidth(),i=e.internal.pageSize.getHeight();for(let s=1;s<=a;s++)e.setPage(s),e.setFontSize(7),(0,r.setKoreanFont)(e,"normal"),e.setTextColor(150,150,150),e.text(`OwnerView Document  |  ${t}  |  Page ${s}/${a}`,n/2,i-8,{align:"center"})}e.s(["generateContractPDF",()=>u,"generateDocumentPDF",()=>l,"generateQuotePDF",()=>d,"issueDocument",()=>c])}]);