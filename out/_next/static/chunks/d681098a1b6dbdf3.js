...
<div class="contract-page">
  ...
  <div class="article">
    ...
    <div class="article-body">
      <p>본 계약은 "${p(l)}"(이하 "본 건"이라 한다)에 관하여 갑과 을 사이의 권리\xb7의무 관계를 명확히 규정함을 목적으로 한다.</p>
    </div>
  </div>
...
</html>`}function p(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function m(e){let t=await fetch(e),a=await t.blob();return new Promise((e,t)=>{let n=new FileReader;n.onloadend=()=>e(n.result),n.onerror=t,n.readAsDataURL(a)})}function g(e){let t=Math.abs(e);return`${e<0?"-":""}${t.toLocaleString("ko-KR")}`}function _(e,t){let a=e.getNumberOfPages(),n=e.internal.pageSize.getWidth(),i=e.internal.pageSize.getHeight();for(let s=1;s<=a;s++)e.setPage(s),e.setFontSize(7),(0,r.setKoreanFont)(e,"normal"),e.setTextColor(150,150,150),e.text(`OwnerView Document  |  ${t}  |  Page ${s}/${a}`,n/2,i-8,{align:"center"})}e.s(["generateContractPDF",()=>u,"generateDocumentPDF",()=>d,"generateQuotePDF",()=>l,"issueDocument",()=>c])}]);